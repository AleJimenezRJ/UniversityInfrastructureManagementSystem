...
internal class BuildingsServices : IBuildingsServices
{
    ...
    /// name="lastId"/> parameter enables efficient pagination by fetching results after the specified ID. Ensure that
    /// the <paramref name="pageSize"/> is set appropriately to balance performance and data transfer size.</remarks>
