...
{
    /// <summary>
    /// Retrieves a collection of learning components based on pagination parameters.
    /// </summary>
    /// <param name="pageSize">The number of learning components to retrieve in a single batch.</param>
