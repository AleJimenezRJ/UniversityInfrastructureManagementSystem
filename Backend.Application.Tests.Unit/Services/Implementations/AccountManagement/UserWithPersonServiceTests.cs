...
public class UserWithPersonServiceTests
{
    ...
    public UserWithPersonServiceTests()
    {
        ...
        _serviceUnderTest = new UserWithPersonService(_userWithPersonRepositoryMock.Object);

        _validUser = new UserWithPerson(
            userName: Domain.ValueObjects.UserName.Create("juan.perez"),
            firstName: "Juan",
            lastName: "Perez",
            email: Domain.ValueObjects.Email.Create("juanperez@gmail.com"),
            phone: Domain.ValueObjects.Phone.Create("8888-9999"),
            identityNumber: Domain.ValueObjects.IdentityNumber.Create("1-1765-0932"),
            birthDate: Domain.ValueObjects.BirthDate.Create(new DateOnly(2000, 4, 29)),
