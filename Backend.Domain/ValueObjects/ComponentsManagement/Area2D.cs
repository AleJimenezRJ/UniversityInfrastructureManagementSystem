...
public class Area2D : ValueObject
{
    ...
    /// <summary>
    /// Returns a string representation of the <see cref="Area2D"/> instance, showing its length and height.
    /// </summary>
    /// <returns>A string in the format "Length:{Length}, Height:{Height}".</returns>
