...
public interface IFloorRepository
{
    ...
    /// <summary>
    /// Lists floors available on a specific building with pagination.
    /// </summary>
    /// <param name="buildingId">The internal Id of the building.</param>
    ...
    /// </returns>
    Task<PaginatedList<Floor>> ListFloorsPaginatedAsync(int buildingId, int pageSize, int pageIndex);
