...
internal class LearningSpaceServices : ILearningSpaceServices
{
    ...
    /// The task result contains a list of <see cref="LearningSpaceOverviewDto"/> entities in the specified building and floor,
    ...
    /// <summary>
    /// Retrieves learning spaces for a specific floor in a building with pagination.
    /// </summary>
    /// <param name="floorId">The internal Id of the floor.</param>
    ...
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains a paginated list of <see cref="LearningSpaceOverviewDto"/>
    /// objects in the specified building and floor.
    /// </returns>
    public Task<PaginatedList<LearningSpaceOverviewDto>?> GetLearningSpacesListPaginatedAsync(int floorId, int pageSize, int pageIndex, string searchText)
    {
        return _learningSpaceRepository.ListLearningSpacesPaginatedAsync(floorId, pageSize, pageIndex, searchText);
    }
